...
We plotted ILI- and rILI- as a function of the week within each flu season and stratified by region (Figure 1). We do not observe strong signal of anomalous patterns of ILI rates that are not due to influenza. In several regions the fraction of ILI not attributable to influenza is near or above the highest observed rates in previous seasons, although qualitatively it does not appear to be substantially higher than previous years. In recent weeks there is a trend of a lower fraction of clinical speciments testing negative for influenza relative to wILI, but these changes cannot be said to be sustained at this time, and are still well within historical norms.
